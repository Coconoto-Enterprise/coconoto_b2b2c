    ...
    <section className="pt-44 md:pt-[359px] lg:pt-[26vh] bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-full mx-auto relative z-10">
        <div className="text-center px-6">
          <h1 className="text-3xl md:text-5xl lg:text-6xl mt-8 font-bold md:font-extrabold text-gray-900 mb-4 md:mb-6">
            Welcome to Coconoto
          </h1>
          <p className="text-lg md:text-2xl lg:text-3xl text-gray-600 md:font-semibold mb-8 px-4 md:px-0 leading-relaxed">
