  ...
  return (
    <section className="py-16 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
        ...
        <div className="w-full lg:w-1/2 relative overflow-hidden rounded-lg min-h-[300px] lg:min-h-[500px]">
        ...
        <div className="w-full lg:w-1/2 space-y-6 lg:space-y-8">
          ...
          <div className="space-y-4 lg:space-y-6">
            <div>
              <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-3 text-center lg:text-left">
                Our Machines
              </h3>
              <p className="text-gray-600 leading-relaxed text-center lg:text-left px-4 lg:px-0">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4 text-center lg:text-left px-4 lg:px-0">
              ...
              <p className="text-gray-600 mt-4 text-center lg:text-left px-4 lg:px-0">
